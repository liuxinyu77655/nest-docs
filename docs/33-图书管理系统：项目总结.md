...
![](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/33-1.png)
...
![](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/33-2.png)

用这个账号登录：

![](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/33-3.png)

根据书名搜索图书：

![](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/33-4.png)

新增图书：

![](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/33-5.png)

编辑图书：

![](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/33-6.png)

删除图书：

![](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/33-7.png)
