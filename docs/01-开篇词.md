...
> 来源：[Nest通关秘籍](https://nest-docs.liushuaiyang.com/1.%20%E5%BC%80%E7%AF%87%E8%AF%8D.html)

一直做前端开发，都会有成为全栈工程师的想法，而 Nest 就是一个很好的途径，它是 Node 最流行的企业级开发框架，提供了 IOC、AOP、微服务等架构特性。

![](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/1-1.png)
