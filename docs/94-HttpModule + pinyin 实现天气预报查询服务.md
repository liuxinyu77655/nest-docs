...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-1.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-2.png)

之后进入[控制台](https://console.qweather.com/#/console)，点击创建项目：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-3.png)

这里大家选择免费订阅（我别的项目用了，就没免费名额了），指定 key 的名字：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-4.png)

然后就可以看到你的 key 了：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-5.png)

如果我们要查询青岛未来 7 天的天气。

需要先查询青岛的 id：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-6.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-7.png)

这里返回了从 2024-5-1 到 2024-5-7 的天气。

具体字段的解释可以看[文档](https://dev.qweather.com/docs/api/weather/weather-daily-forecast/#返回数据)：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-8.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-9.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-10.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-11.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-12.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-13.png)

访问下试试：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-14.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-15.png)

这样就好了：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-16.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-17.png)

这里可以填入各种请求配置，比如 baseURL 等，其实就是 new 了一个 Axios 实例：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-18.png)

然后在用到的地方注入 httpService：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-19.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-20.png)

测试下：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-21.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-22.png)

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/94-23.png)
