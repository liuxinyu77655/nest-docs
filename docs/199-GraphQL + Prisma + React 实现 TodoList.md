...
查询：![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-1.png)

新增：![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-2.png)

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-3.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-4.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-5.png)

跑起来后，搜索 mysql 镜像（这步需要科学上网），点击 run：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-6.png)

输入容器名、端口映射、以及挂载的数据卷，还要指定一个环境变量：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-7.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-8.png)

跑起来后，我们用 GUI 客户端连上，这里我们用的是 mysql workbench，这是 mysql 官方提供的免费客户端：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-9.png)

连接上之后，点击创建 database：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-10.png)

指定名字、字符集为 utf8mb4，然后点击右下角的 apply。

创建成功之后在左侧就可以看到这个 database 了：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-11.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-12.png)

生成了 schema 文件（用来定义 model 的），和 .env 文件：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-13.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-14.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-15.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-16.png)

这时候数据库就就有这个表了：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-17.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-18.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-19.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-20.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-21.png)

首先是 list，现在没有数据：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-22.png)

然后添加一个：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-23.png)

服务端打印了 insert into 的 sql：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-24.png)

数据库也有了这条记录：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-25.png)

再加一个：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-26.png)

然后查一下：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-27.png)

接下来试下修改、删除：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-28.png)

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-29.png)

再查一下：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-30.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-31.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-32.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-33.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-34.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-35.png)

试一下新增：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-36.png)

查询：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-37.png)

修改：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-38.png)

单个查询：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-39.png)

删除：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-40.png)

查询：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-41.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-42.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-43.png)

这里涉及到的跨域，现在后端服务里开启下跨域支持：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-44.png)

可以看到，返回了查询结果：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-45.png)

然后加一下新增：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-46.png)
...
![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-47.png)

数据库里也可能看到新增的数据：

![img](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/199-48.png)
