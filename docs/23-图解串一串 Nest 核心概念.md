...
![](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/23-1.png)

token 可以是 class 也可以是 string：

![](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/23-2.png)
...
![](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/23-3.png)
...
![](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/23-4.png)

在 main.ts 里调用 NestFactory.create 方法，就会从 AppModule 开始递归解析 Module，实例化其中的 provider、controller，并依次调用它们的 onModuleInit 生命周期方法。

![](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/23-5.png)
...
![](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/23-6.png)
