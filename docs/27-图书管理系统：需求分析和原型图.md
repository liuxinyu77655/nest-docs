...
![](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/27-1.png)
...
![](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/27-2.png)

通过用户名、密码登录。

## 注册

![](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/27-3.png)

注册需要填入用户名、密码、确认密码。

## 书籍列表

![](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/27-4.png)

登录后可以查看书籍列表，可以通过书名来模糊搜索。

## 新增书籍

![](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/27-5.png)

点击新增书籍按钮会有个弹窗，输入书名、作者、描述，上传封面后，点击新增就可以新增书籍。

## 修改书籍

![](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/27-6.png)

点击书籍列表里的修改按钮，可以修改书籍信息。

## 书籍详情

![](https://vercel-nestjs.oss-cn-beijing.aliyuncs.com/nest-docs/image/27-7.png)
